...
function SectionLabel({
  ...
  return (
    <div className={`flex items-center gap-2 ${justify}`}>
      <Sparkle className="h-3 w-3 text-white/70" {...ICON_PROPS} />
...
export function MaxReedPage() {
  return (
    <section
      className="min-h-screen lg:h-screen bg-[#0a0a0a] text-white antialiased px-4 sm:px-6 md:px-10 lg:px-14 py-6 sm:py-8 md:py-10"
    >
      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 mb-6 md:mb-8">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-sm md:text-[15px] leading-[1.6] text-white/60 max-w-3xl">
            ...
            web-ready products, and story-first campaigns. With a decade of craft
            behind me, I help ideas move with focus and intention.
          </p>
        </div>
        <button
          type="button"
          className="liquid-glass rounded-full px-5 sm:px-6 py-2.5 sm:py-3 text-sm shrink-0 self-start"
        >
          Let&apos;s Team Up Today
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5">
        <div className="relative rounded-2xl bg-black overflow-hidden min-h-[420px] flex flex-col justify-between p-5 md:p-6">
          <video
            autoPlay
            loop
            muted
        ...
        <div className="grid md:grid-rows-[auto_1fr] gap-4 md:gap-5">
          <div className="relative rounded-2xl bg-[#324444] p-5 md:p-6 noise-overlay min-h-[180px] flex flex-col gap-4">
          ...
          <div className="relative rounded-2xl bg-black overflow-hidden min-h-[280px] flex flex-col items-center justify-center p-5">
            <video
              autoPlay
              loop
              muted
              ...
              src={STAT_VIDEO}
            />
            <p className="relative z-10 text-5xl sm:text-6xl md:text-7xl lg:text-[88px] font-light tracking-tight drop-shadow text-center">
              10M+
            </p>
        ...
        <div className="grid gap-4 md:gap-5">
          <div className="relative rounded-2xl bg-black overflow-hidden min-h-[320px] flex flex-col justify-between p-5 md:p-6">
            <video
              autoPlay
              loop
              muted
            ...
            />
            <div className="relative z-10">
              <SectionLabel label="Daily Software" />
            </div>
          ...
          <div className="relative rounded-2xl bg-[#324444] p-5 md:p-6 noise-overlay min-h-[160px]">
            <div className="flex items-start justify-between">
              <SectionLabel label="Reach Me" align="start" />
              <button
                type="button"
                className="h-9 w-9 rounded-full liquid-glass flex items-center justify-center"
                aria-label="Contact"
              >
                <ArrowUpRight className="h-4 w-4" {...ICON_PROPS} />
              </button>
            </div>
